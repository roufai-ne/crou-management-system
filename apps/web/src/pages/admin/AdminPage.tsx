...
export const AdminPage: React.FC = () => {
  ...
  // DEBUG: Afficher la pagination
  console.log('📊 AdminPage - usersPagination:', usersPagination);
  console.log('📊 AdminPage - users.length:', users.length);
  console.log('📊 AdminPage - updateUsersPagination:', updateUsersPagination);

  // Log de la pagination passée à DataTable
  const paginationForTable = usersPagination ? {
    page: usersPagination.page,
    limit: usersPagination.limit,
    total: usersPagination.total,
    onPageChange: (page: number) => updateUsersPagination({ page }),
    onLimitChange: (limit: number) => updateUsersPagination({ limit, page: 1 })
  } : undefined;

  console.log('📊 AdminPage - paginationForTable:', paginationForTable);
  ...
  const availableRoles = useMemo(() => {
    ...
    // Le rôle est maintenant une string directement dans user.role
